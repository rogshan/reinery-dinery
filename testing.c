//testing.c
//Testing file for CE4703 assignment 3
//Contains test functions to test fucntionality off assignmentMain.c
...
test testCreatePoly()
{
  ...
  test testAddNode()
  {
    stNode *testNode;                           //creates a node for the test
  ...
  test testDeletePoly()
  {
    ...
    polyTest->current->coeff = 1;    //assigns a value to the coefficient of the node
    polyTest->current->pow = 0;        //assigns a value to the power of the node
    polyTest->current = polyTest->current->nextptr; //moves to the next node
    polyTest->current->coeff = 5;          //assigns a value to the coefficient of the node
    polyTest->current->pow = 2;            //assigns a value to the power of the node
    polyTest->current = polyTest->current->nextptr; //moves to the next node
    polyTest->current->coeff = 3;          //assigns a value to the coefficient of the node
    polyTest->current->pow = 3;            //assigns a value to the power of the node
    //if pointer returned
